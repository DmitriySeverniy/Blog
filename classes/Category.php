...
class Category
{
  ...
  //@return Category|false Объект Category object или false, 
  //если запись не была найдена или в случае другой ошибки
  ...
  //@return Array|false Двух элементный массив: results => массив с объектами Category; 
  //totalRows => общее количество категорий
